...
class Project(Base):
    ...
    contract_material_cost = Column(Numeric(18, 2), default=0)
    contract_labor_cost = Column(Numeric(18, 2), default=0)
    sales_domestic_material_cost = Column(Numeric(18, 2), default=0)
    sales_overseas_material_cost = Column(Numeric(18, 2), default=0)
    sales_outsourcing_cost = Column(Numeric(18, 2), default=0)
    sales_labor_cost = Column(Numeric(18, 2), default=0)
    sales_expense_cost = Column(Numeric(18, 2), default=0)
    sales_indirect_cost = Column(Numeric(18, 2), default=0)
